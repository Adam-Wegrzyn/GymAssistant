...
//public class  GymAssistantDbContext: GymAssistantDbContext
//{
//    private readonly string _connectionString;
//    public GymAssistantDbContext(DbContextOptions<GymAssistantDbContext> options, string connectionString) : base(options) {
